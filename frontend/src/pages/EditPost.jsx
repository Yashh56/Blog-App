    ...
    <div>
      ...
      <div className='px-6 md:px-[200px] mt-8'>
        ...
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
          <input onChange={e => setTitle(e.target.value)} value={title} type="text" placeholder='Enter the Post Title' className='px-2 py-4 outline-none' />
          ...
          <button onClick={handleUpdate} className='bg-black w-full md:w-[20%] mx-auto  text-white px-4 py-2 font-semibold'>Update Post</button>
        </form>
      </div>
      <Footer />
    </div>
